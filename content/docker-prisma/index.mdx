---
title: Set up a Nodejs, Prisma and PostgreSQL backend environment with Docker
...
<br />
At this end of this guide, you should be able to have your complete back-end environment
